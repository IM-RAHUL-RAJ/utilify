...
class News extends React.Component {
  ...
  async componentDidMount() {
    ...
    let res = await fetch(
      `https://newsapi.org/v2/everything?q=${this.props.newsName}&apiKey=e8f514bea7ef4bdb879e507afefc40bf`
    );
        ...
        <div class="p-8">
          ...
          <div class="max-w-sm rounded overflow-hidden shadow-lg">
            ...
            <div class="px-6 pt-4 pb-2">
              ...
              <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#rahulraj</span>
